...
<!--EFECTOS DE NAVIDAD-->
    ...
    <div class="col-xs-12 col-sm-12 col-md-12" id="panelHome">
        ...
        <div class="panel-heading container">
            ...
            <div class="panel-body col-xs-11">
                
            <div class="col-md-12 col-md-offset-1">
                <h4>Crear instrumento</h4>

                <form>
                  <div class="form-group">
                        <label for="ejemplo_email_1">Nombre del Instrumento</label>
                        <input type="email" class="form-control" id="ejemplo_email_1"
                           placeholder="Ej: Acreditacion Institucional Docente">
                  </div>
                  <div class="form-group">
                  <label for="ejemplo_email_1">Descripción</label>
                      <textarea rows="4" cols="50" for="ejemplo_password_1" class="form-control" id="ejemplo_password_1"></textarea> 
                  </div>
                  
                </form>

                    <div>
                    <a href="CrearInstrumentoSecciones.php"><button type="submit" class="btn btn-default col-md-3 col-md-offset-3">Siguiente</button></a>

                    <a href="../index.php"index.php'><button type="submit" onclick="index.php" class="btn btn-default col-md-3 col-md-offset-1">Volver</button></a>
                     </div>
            </div>
            </div> 
        </div>
